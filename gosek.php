...
$tools = trim(fgets(STDIN));
	...
	{ 
		echo "\n-----------------------------------------------\n";
		echo "INFO - 08 Gawe Nomor Indo dan 1 Gawe Nomer US\n";
		echo "-----------------------------------------------\n";
		echo "Nomer HP: ";
		...
		if($regs->success == true) {
			...
			die("ERROR - Gowo nomor anyar lah Su!");
		}
	} else if($tools == "2")
	{
		echo "\n-----------------------------------------------\n";
